// synatxx for using custom selctor
...
// for one ticked checkbox
let checkCount = 0;
handleSlider();

// set circle colour to gray
setIndicator("#ccc")
...
function shufflePassword(array){
    // fischer yates method is used for shuffling
